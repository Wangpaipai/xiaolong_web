    ...
    <section class="wrapper">
        ...
        <div>
            ...
            <p>
                ...
                <a href="http://www.videaba.com/" target="_blank" style="color: #00a2d4">在文本编辑器-微助点编辑器</a> &nbsp;&nbsp;&nbsp;
                <span class="help-block">* 在编辑器中排版号文本内容，在编辑器中右侧内容框中：Ctrl+A全选复制，然后粘贴到后端管理系统里面去</span>
                <span class="help-block">* 编辑器只有在富文本输入框中才可以使用；如：项目的详情、关于我们等</span>
                <span class="help-block">* 在外部编辑器不要上传图片，直接排好版复制过来了再在本地修改图片！！！！！！</span>
            </p>
            <br/>
            <br/>
            <p class="help-block">注：所有上传图片中，标注的尺寸单位均未PX像素单位；等比例就是长宽可以按比例扩大，强制尺寸是指必须要标注的尺寸大小。</p>
