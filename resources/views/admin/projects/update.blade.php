                            ...
                            <form class="form-validate form-horizontal" id="feedback_form" method="get" action="">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10" id="coverUpload">
                                        ...
                                        <input id="coverInput" class="form-control" name="banner" type="hidden" value="{{ $data->banner }}" required />
                                    </div>
                                </div>
...
<script>
$(function(){
  var banner = {!! empty($data->banner) ? '[]' : htmlspecialchars_decode($data->banner) !!}
