                        ...
                        <div class="form">
                            <form class="form-validate form-horizontal" id="feedback_form" method="get" action="">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" name="title" minlength="5" type="text" value="" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" name="client" type="text" value="" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">幻灯片 <span class="required">*</span></label>
                                    <div class="col-lg-10" id="coverUpload">
                                        <img id="banner0" src="" height="100" />
                                        <img id="banner1" src="" height="100" />
                                        <img id="banner2" src="" height="100" />
                                        <img id="banner3" src="" height="100" />
                                        <button id="coverImgUpload" class="btn btn-success" type="button"> + 点击上传</button>
                                        <input id="coverInput" class="form-control" name="banner" type="hidden" value="" required />
                                    </div>
                                </div>
...
$(function(){
  ...
  var bannerUploader = Qiniu.uploader({
    ...
    browse_button: 'coverImgUpload',       //上传选择的点选按钮，**必需**
    ...
    container: 'coverUpload',           //上传区域DOM ID，默认是browser_button的父元素，
    max_file_size: '2000mb',           //最大文件体积限制
    flash_swf_url: './plupload/Moxie.swf',  //引入flash,相对路径
    max_retries: 3,                   //上传失败最大重试次数
    dragdrop: true,                   //开启可拖曳上传
    drop_element: 'coverUpload',        //拖曳上传区域元素的ID，拖曳文件或文件夹后可触发上传
    ...
    init: {
      ...
      'FileUploaded': function(up, file, info) {
        ...
        banner = banner.splice(-4, 4)
        for (i = 0; i < 4; i++) {
          $("#banner" + i).attr("src", banner[i])
        }
        $("#coverInput").val(JSON.stringify(banner))
      },
