                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            @foreach($data as $u)
                                <tr>
                                    ...
                                    <td>
                                        <img height="100" src="{{ $u->small_url }}" />
                                    </td>
                                    <td>{{ $u->title }}</td>
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-primary edit-data" data-id="{{ $u->id }}" href="{{ route('admin.banner.edit', ['id' => $u->id]) }}"><i class="icon_pencil-edit"></i></a>
